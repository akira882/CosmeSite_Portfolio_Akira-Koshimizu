      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {FEATURES.map((feature, index) => (
            <div 
              key={feature.title} 
              className={`flex flex-col items-center text-center p-6 border border-brand-100 hover:border-brand-300 transition-all duration-700 bg-brand-50/50 hover:bg-white hover:shadow-lg ${
        ...
        <div className="mt-24 flex flex-col md:flex-row items-center gap-12 bg-brand-900 text-brand-50 rounded-sm overflow-hidden shadow-2xl">
          <div className="w-full md:w-1/2 h-80 md:h-[500px]">
             <img 
               src="https://images.unsplash.com/photo-1587593810167-a6492031e54a?q=80&w=2574&auto=format&fit=crop" 
