...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen min-h-[700px] w-full overflow-hidden">
      ...
      <div
        ref={elementRef}
        className={`relative z-10 h-full flex flex-col justify-center items-center text-center px-4 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
      >
